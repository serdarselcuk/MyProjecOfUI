...
import static com.test.patientPortal.utils.Constants.BROWSER;
...
public class Driver {
    ...
    public static WebDriver get() {
        ...
        if (driverPool.get() == null) {
            ...
            String browser = systemBrowser == null ? BROWSER : systemBrowser;
            switch (browser) {
                case "chrome":
                ...
                case "remote_firefox":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL(""), firefoxOptions));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
