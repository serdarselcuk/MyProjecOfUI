...
public class BrowserUtils {
     ...
     * @param element
     */
    public static WebElement non_staleElement(WebElement element) {
...
//        String date = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));​
     ...
     */
    public static void waitForPageToLoad(long timeOutInSeconds) throws NullPointerException {
    ...
    public static void waitUntilAttributeBeCameActive(WebElement element, String attribute, String value) throws TimeoutException {
        WebDriverWait wait = new WebDriverWait(Driver.get(), 10);
        waitForPresenceOfElement("#home-button");
        wait.until(ExpectedConditions.attributeContains(element, attribute, value));
    }

    public static void waitForPresenceOfElement(String css_locator) {
        WebDriverWait wait = new WebDriverWait(Driver.get(), 10);
        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(css_locator)));
    }
     ...
     * @param pageTitle
     */
    public static void waitForPageTitle(String pageTitle) throws TimeoutException {
    ...
    public static <E extends Comparable<E>> boolean isSorted(List<E> list) {
        List<E> list1 = new ArrayList<>(list);
